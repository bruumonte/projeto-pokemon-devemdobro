...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        ...
        //passo 4 - adicionar a classe modo-escuro no body dentro do evento de click
    ...
    //o código JS roda de baixo pra cima, por isso precisamos colocar a ordem certa do código.
